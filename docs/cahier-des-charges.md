...
- **Qualité des données.** Le contrôle initial ne montre ni doublon ni clé orpheline (vente rattachée à un produit, magasin ou client inexistant). Quelques valeurs manquent sans impact sur les KPIs : entreprise pour 105 clients, poids pour 284 produits. Les codes postaux mélangent chiffres et lettres selon les pays (Canada, Royaume-Uni, Pays-Bas) et comportent parfois des zéros initiaux : ils doivent être traités comme du texte.
